...
/*   Updated: 2024/09/19 17:08:59 by faguirre         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	int	result[] = 
	{
		...
		test_ft_put(print),
		test_ft_lstnew("TEST ft_lstnew", print),
		test_ft_lstadd_front("TEST ft_lstadd_front", print),
		test_ft_lstsize("TEST ft_lstsize", print),
		test_ft_lstlast("TEST ft_lstlast", print),
		test_ft_lstadd_back("TEST ft_lstadd_back", print),
		test_ft_lstdel(),
		test_ft_lstiter("TEST ft_lstiter", print),
		test_ft_lstmap("TEST ft_lstmap", print)
	};
