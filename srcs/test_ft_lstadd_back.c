...
/*   Updated: 2024/09/19 13:17:49 by faguirre         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int	test(int print)
{
	...
	fail1 = 0;
	list1 = NULL;
	ft_lstadd_back(&list1, ft_lstnew("Node1"));
	...
	ft_lstadd_back(&list2, ft_lstnew("Node2"));
	fail2 += strcmp((char *)list2->content, "Node1") != 0;
	fail2 += strcmp((char *)list2->next->content, "Node2") != 0;
	if (print >= 2)
